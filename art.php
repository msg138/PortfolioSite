  ...
  <body class='container-fluid'>
    ...
    <section class='section-art row justify-content-center'>
      <div class='section-art__info col-12 col-sm-6 col-md-6'>
        <i class='fa fa-paint-brush mfa paintbrush-animation'></i><br /> <br />
        <div class= 'content'>
    ...
    <section class='section-art-list row justify-content-center'>
      ...
      <div class='section-art__item col-12 col-sm-6 col-md-4'>
        <div class='section-art__include' loadref='art/moneygrab.php'>
            <div class='placeholder'>
                Click To Load Art
            </div>
        </div>
        ...
        <div class= 'content'>
            Robber has his eye on that gold coin. Made with Pure CSS <br />
            <a href='https://github.com/msg138/PortfolioSite/blob/master/art/moneygrab.php' class='section-projects__link source'><i class='fa fa-github mfa'></i>&nbsp;Source</a>
        </div>
      </div>
    </section>
